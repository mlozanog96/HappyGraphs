...
1. GDP per capita: This feature has the highest impact on the prediction of a country's GDP. It is the most influential factor in determining the economic output per person.  \n 
...
3. Primary school completion: This feature ranks third in importance. It represents the percentage of individuals who have successfully completed primary education. Education is a key factor in human capital development and has long-term impacts on economic growth.  \n 

4. Percentage of people with overweight: This feature has a medium impact on GDP predictions. It indicates the proportion of the population with overweight or obesity, which can have implications for health and healthcare costs.  \n 
...
7. Foreign investments: This feature has a medium impact on GDP predictions. It represents the inflow of foreign capital into the country, which can have positive effects on economic growth and development.  \n 
...
11. Primary net income: This feature has a relatively low impact. It refers to the net income or earnings from primary sectors such as agriculture, mining, and forestry. While important for certain economies, it may have less influence on overall GDP predictions.  \n 
