...
radar_indicators = col1.multiselect("Select indicators", sorted(available_indicators_radar), default=['People using at least basic drinking water services', 'Forest area', 'Access to electricity'])
