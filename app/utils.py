...
def filter_projects(charity_country=None, charity_title=None, charity_region=None, charity_theme_name=None):
    '''
    Function to filter charity projects based on various criteria
    Takes optional parameters 'charity_country', 'charity_title', 'charity_region', and 'charity_theme_name'
    As a result, the function returns a list of filtered charity projects or None if no matches found
    '''
    keys ={}
